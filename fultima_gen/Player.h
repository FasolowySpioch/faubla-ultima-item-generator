...
private:
	...
	WeaponType _preffered_weapon_type;
...
public:
	Player() : _level(5), _primary_die1(Atributes::WLP), _primary_die2(Atributes::WLP),
		_preffered_weapon_type(WeaponType::ARCANE), _canMartialWeapon(false), _canMartialArmor(false),
		_canRange(false), _canShield(false), _name("") {
	}
	Player(int level, Atributes primary_die1, Atributes primary_die2,
		WeaponType preffered_weapon_type, bool canMartialWeapon,
	...
	WeaponType getPrefferedWeaponType();
	...
	void setPrefferedWeaponType(WeaponType pwt);
